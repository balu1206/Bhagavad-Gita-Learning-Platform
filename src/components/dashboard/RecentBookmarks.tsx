...
const PLACEHOLDER_BOOKMARKS = [
  { id: '1', chapter: 2, verse: 47, chapterTitle: 'Sankhya Yoga',  preview: 'You have a right to perform your duties, but not to the fruits...' },
  { id: '2', chapter: 4, verse: 7,  chapterTitle: 'Jnana Karma Yoga', preview: 'Whenever dharma declines and adharma rises, I manifest...' },
  { id: '3', chapter: 9, verse: 22, chapterTitle: 'Raja Vidya Yoga',  preview: 'To those who worship me with devotion, I carry what they lack...' },
];

export function RecentBookmarks() {
  if (PLACEHOLDER_BOOKMARKS.length === 0) {
    return (
  ...
  return (
    <Card variant="elevated" className="p-6">
      ...
      <div className="space-y-3">
        {PLACEHOLDER_BOOKMARKS.map((bm) => (
          <Link
            key={bm.id}
            href={`/chapters/${bm.chapter}/${bm.verse}`}
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-dark-600 dark:text-dark-300 truncate">{bm.preview}</p>
            </div>
